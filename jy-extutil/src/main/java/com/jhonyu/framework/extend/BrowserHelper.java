...
public class BrowserHelper
{
     ...
     * @Description: 判断是否是IE
     * @userName: jiangyu
     * @date: 2016年1月4日 下午5:50:57
     * @param request
     * @return
     */
    public static boolean isIE(HttpServletRequest request)
    {
        return (request.getHeader("USER-AGENT").toLowerCase().indexOf("msie") > 0 || request.getHeader(
            "USER-AGENT").toLowerCase().indexOf("rv:11.0") > 0) ? true : false;
    }

    /**
     * @Description: 获取IE版本
     * @userName: jiangyu
     * @date: 2016年1月4日 下午5:51:24
     * @param request
     * @return
     */
